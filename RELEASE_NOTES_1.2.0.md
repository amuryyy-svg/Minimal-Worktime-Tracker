...
### Stability
- Fixed the mismatch between the app's autostart settings and the actual Windows state.
...
- Added a configurable day rollover time so late-night work keeps counting toward the intended workday.
